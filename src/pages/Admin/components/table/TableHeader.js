// frontend/src/pages/SearchRecords/components/table/TableHeader.js
...
const TableHeader = ({ collapsedSections, toggleSection, getColumnCount }) => {
  ...
  {!collapsedSections.testing && (
    <th
      colSpan={getColumnCount('testing')}
...
*/}
  ...
  {!collapsedSections.qualityIndicator && (
    <th
      colSpan={getColumnCount('qualityIndicator')}
      className="section-header"
      onClick={() => toggleSection('qualityIndicator')}
    >
      <FontAwesomeIcon icon={faChevronDown} />
      Quality Indicator
    </th>
...
*/}
  ...
  {!collapsedSections.teamLocation && (
    <th
      colSpan={getColumnCount('teamLocation')}
      className="section-header master-section"
      onClick={() => toggleSection('teamLocation')}
    >
      <FontAwesomeIcon icon={faChevronDown} />
  ...
  {collapsedSections.teamLocation && (
    <th
      className="section-header master-section collapsed"
      onClick={() => toggleSection('teamLocation')}
    >
      <FontAwesomeIcon icon={faChevronRight} />
      <span>Team</span>
  ...
  {!collapsedSections.buildInfo && (
    <th
      colSpan={getColumnCount('buildInfo')}
      className="section-header master-section"
      onClick={() => toggleSection('buildInfo')}
    >
      <FontAwesomeIcon icon={faChevronDown} />
      ...
      <tr>
        ...
        {!collapsedSections.cpuInfo && (
          <>
            ...
            <th className="col-standard">CPU P0 S/N</th>
            <th className="col-standard">P0 Socket Date Code</th>
            <th className="col-standard">CPU P1 S/N</th>
            <th className="col-standard">P1 Socket Date Code</th>
        ...
        {!collapsedSections.componentInfo && (
          <>
            ...
            <th className="col-standard">DIMM S/N</th>
          </>
        )}
        {collapsedSections.componentInfo && (
          <th className="collapsed-column-header col-collapsed"></th>
...
*/}
  ...
  {!collapsedSections.rma && (
    <>
      <th className="col-standard" style={{ backgroundColor: '#e8f5e9' }}>Pass / Fail</th>
      <th className="col-wide" style={{ backgroundColor: '#e8f5e9' }}>Notes</th>
      <th className="col-standard" style={{ backgroundColor: '#e8f5e9' }}>DIMM</th>
      <th className="col-standard" style={{ backgroundColor: '#e8f5e9' }}>BMC</th>
      <th className="col-standard" style={{ backgroundColor: '#e8f5e9' }}>M.2</th>
      <th className="col-standard" style={{ backgroundColor: '#e8f5e9' }}>Liquid Cooler</th>
      <th className="col-standard" style={{ backgroundColor: '#e8f5e9' }}>Location</th>
      <th className="col-standard" style={{ backgroundColor: '#e8f5e9' }}>RMA</th>
      <th className="col-standard column-group-separator" style={{ backgroundColor: '#e8f5e9' }}>Status</th>
    </>
  )}
  {collapsedSections.rma && (
    <th className="collapsed-column-header master-section col-collapsed"></th>
