                    ...
                    <div className="user-guide-modal corporate-modal" onClick={(e) => e.stopPropagation()}>
                      ...
                      <div className="user-guide-content corporate-content">
                        ...
                        <div className="faq-section">
                          ...
                          <h3 style={{ color: '#1565c0', marginTop: '32px', textAlign: 'left' }}>Import ChangeGear Asset ID Template</h3>
                          <p style={{ marginBottom: '16px', color: '#6c757d', fontSize: '14px', lineHeight: '1.5' }}>
                            Download the standardized Excel template for changegear asset ID import. Template includes sample data, and instructions.
                          </p>
                          <a
                            href={api.getChangegearTemplateUrl()}
                            className="guide-link"
                            style={{ display: 'inline-block', textDecoration: 'none' }}
                          >
                            <div style={{
                          ...
                          <h3 style={{ color: '#1565c0', marginTop: '32px', textAlign: 'left' }}>User Incident Ticketing System</h3>
                          <p style={{ marginBottom: '16px', color: '#6c757d', fontSize: '14px', lineHeight: '1.5' }}>
                            A User Incident Ticketing System lets users submit issues into a system, which records them and automatically notifies the relevant team for tracking and resolution.
                          </p>
                          <a
                            href="https://amdcloud-my.sharepoint.com/:x:/g/personal/epoh_amd_com/IQASuk27jSW3Qbx3ZxAMg2w7AeQdt-3jzPFx8v-3DTu3ONo"
                            target="_blank"
                            rel="noreferrer"
